...
def points_in_boxes_cpu(points, boxes):
    ...
    roiaware_pool3d.points_in_boxes_cpu(boxes.float().contiguous(), points.float().contiguous(), point_indices)
...
def points_in_boxes_gpu(points, boxes):
    ...
    roiaware_pool3d.points_in_boxes_gpu(boxes.contiguous(), points.contiguous(), box_idxs_of_pts)
...
class RoIAwarePool3dFunction(Function):
    ...
    def forward(ctx, rois, pts, pts_feature, out_size, max_pts_each_voxel, pool_method):
        ...
        roiaware_pool3d.forward(rois, pts, pts_feature, argmax, pts_idx_of_voxels, pooled_features, pool_method)
    ...
    def backward(ctx, grad_out):
        ...
        roiaware_pool3d.backward(pts_idx_of_voxels, argmax, grad_out.contiguous(), grad_in, pool_method)
